...
nautical_catch_challenge.divers[3].competition_points = 32.3
nautical_catch_challenge.divers[3].catch.clear()
nautical_catch_challenge.divers[3].catch = nautical_catch_challenge.fish_list[:4]
